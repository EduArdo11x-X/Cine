 ...
 * @author ASUS TUF
 */
public class Modificar_promocion extends javax.swing.JFrame {

    /**
     * Creates new form Registo_promocion
     */
    public Modificar_promocion() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("MODIFICAR LA PROMOCION");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_promocion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificar_promocion().setVisible(true);
            }
        });
    }
